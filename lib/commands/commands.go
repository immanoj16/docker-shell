...
// Commands used to add docker command suggestions
type Commands struct {
	DockerSuggestions    []prompt.Suggest
	DockerSubSuggestions map[string][]prompt.Suggest
}

// New used to create a instance of Commands
func New() Commands {
	return Commands{
		DockerSuggestions: []prompt.Suggest{
...
// GetDockerSuggestions used to get the DockerSuggestions
func (c *Commands) GetDockerSuggestions() []prompt.Suggest {
	return c.DockerSuggestions
}

// GetDockerSubSuggestions used to get the DockerSubuggestions
func (c *Commands) GetDockerSubSuggestions() map[string][]prompt.Suggest {
	return c.DockerSubSuggestions
}

// IsDockerCommand used to check if it is a docker suggestions
...
// IsDockerSubCommand used to check if it is a docker sub suggestions
